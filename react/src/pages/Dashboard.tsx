...
export const Dashboard = () => {
  ...
  useEffect(() => {
    fetchTasks();
  }, [page, statusFilter, searchTerm]); // Add debouncing in real app
  ...
  const handleCreateOrUpdate = async (title: string, description: string, status: string) => {
    try {
      ...
      throw error; // Re-throw to keep modal open logic handling
    }
  };
    ...
    <Layout>
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          ...
          <Button onClick={() => { console.log('New Task Clicked'); openCreateModal(); }}>
        ...
        {isLoading && tasks.length === 0 ? (
          ...
          <div className="text-center py-12 bg-white rounded-lg border border-gray-200 border-dashed">
            ...
            <div className="mt-6">
              <Button onClick={() => { console.log('Empty State New Task Clicked'); openCreateModal(); }}>
                <Plus className="h-5 w-5 mr-1" />
                New Task
              </Button>
            </div>
