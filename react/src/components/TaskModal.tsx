...
// Simple Modal Implementation without Headless UI for speed if needed, but going with custom basic overlay to avoid huge deps if I didn't install headless. 
// Wait, I didn't install @headlessui/react. I'll make a custom one using pure React/Tailwind.
...
export const TaskModal = ({ isOpen, onClose, onSubmit, initialData, title }: TaskModalProps) => {
  ...
  console.log('TaskModal render. isOpen:', isOpen);
